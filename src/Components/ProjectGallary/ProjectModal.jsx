          ...
          <div className="flex items-start gap-6 mb-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-4 text-lg text-gray-300">
                <span className="text-green-500 font-semibold">{project.metrics.performance} Match</span>
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            {project.githubUrl && (
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 bg-gray-700 hover:bg-gray-600 text-white px-6 py-3 rounded-lg font-semibold transition-colors border border-gray-600"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
